...
option_list=list(
    ...
    make_option(c("-b", "--genome_build"), type="character", default=NULL,
        help="Build of Human genome in stufy e.g GRCh37|GRCh38", metavar="character"),
...
write_gwas_vcf(sumstats_dt, study_metadata, opt$genome_build,
