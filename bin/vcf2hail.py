...
recode_harmonised_to_grch38 = {
    '1':'chr1', '2':'chr2', '3':'chr3', '4':'chr4', '5':'chr5', '6':'chr6', '7':'chr7', '8':'chr8', 
    '9':'chr9', '10':'chr10', '11':'chr11', '12':'chr12', '13':'chr13', '14':'chr14', '15':'chr15',
    '16':'chr16', '17':'chr17', '18':'chr18', '19':'chr19', '20':'chr20', '21':'chr21', '22':'chr22', 
    '23':'chrX', '24':'chrY', '26':'chrM'
}

recode_harmonised_to_grch37 = {
    '23':'X', '24':'Y', '26':'MT'
}
...
def main_program():
    ...
    if args.genome_build == 'GRCh38':
        contig_recode = recode_harmonised_to_grch38
    elif args.genome_build == 'GRCh37':
        contig_recode = recode_harmonised_to_grch37
    else:
        contig_recode = None

    mt = hl.import_vcf(args.vcf,
                       reference_genome=args.genome_build,
                       contig_recoding=contig_recode)
