...
# standard_error column sometimes contains nonsensical values - calculate and overwrite 
# SE from more trustworthy CI cols if available
if (all(c('ci_upper', 'ci_lower') %in% colnames(gwas_data))) {
